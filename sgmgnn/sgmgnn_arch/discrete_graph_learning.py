...
class DiscreteGraphLearning(nn.Module):
    ...
    # Define a class for discrete graph learning, inheriting from nn.Module
    def __init__(self, dataset_name, k, input_seq_len, output_seq_len):
        # Initialize the class with dataset name, k for k-nearest neighbors, and sequence lengths
        super().__init__()

        self.k = k          # the "k" of knn graph
        # Dictionary to map dataset names to the number of nodes
        self.num_nodes = {"DYG_wi": 14, "DYG_doz": 14, "METR-LA": 207, "PEMS04": 307, "PEMS03": 358, "PEMS-BAY": 325, "PEMS07": 883, "PEMS08": 170}[dataset_name]
        # Dictionary to map dataset names to the length of training data
        self.train_length = {"DYG_wi": 15925, "DYG_doz": 15925, "METR-LA": 23990, "PEMS04": 13599, "PEMS03": 15303, "PEMS07": 16513, "PEMS-BAY": 36482, "PEMS08": 14284}[dataset_name]
        # Load node features from a pickle file and convert to float tensor, slicing to train length
        ...
        # Dictionary to map dataset names to the dimension for fully connected layer
        self.dim_fc = {"DYG_wi": 254512, "DYG_doz": 254512, "METR-LA": 383552, "PEMS04": 217296, "PEMS03": 244560, "PEMS07": 263920, "PEMS-BAY": 583424, "PEMS08": 228256}[dataset_name]
        self.embedding_dim = 100  # Dimension of the embedding
        ...
        self.dim_fc_mean = {"DYG_wi": 96768, "DYG_doz": 96768, "METR-LA": 16128, "PEMS-BAY": 16128, "PEMS03": 16128 * 2, "PEMS04": 16128 * 2, "PEMS07": 16128, "PEMS08": 16128 * 2}[dataset_name]
    ...
    def forward(self, long_term_history, llmencoder):
        ...
        hidden_states, hidden_prompt = llmencoder(long_term_history[..., [0]])


        Semantic_feat = F.relu(self.fc_mean(hidden_prompt[:, :, -126:, :].reshape(batch_size, num_nodes, -1)))     # relu(FC(Hi)) in Eq. (2)


        node_feat = global_feat + Semantic_feat#[B, N, embedding_dim]
